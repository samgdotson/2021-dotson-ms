...
\newacronym{abbott}{APP}{Abbott Power Plant}
...
\newacronym{ceja}{CEJA}{Climate and Equitable Jobs Act, SB2408}
...
\newacronym{mca}{MCA}{Monte Carlo Analysis}
\newacronym{mga}{MGA}{Modeling-to-Generate-Alternatives}
\newacronym{MILP}{MILP}{mixed-integer linear program}
\newacronym{miso}{MISO}{Mid-continent Independent System Operator}
...
\newacronym{nhes}{NHES}{Nuclear Hybrid Energy System}
...
\newacronym{nsrdb}{NSRDB}{National Solar Radiation Database}
...
\newacronym{prm}{PRM}{planning reserve margin}
\newacronym{PyNE}{PyNE}{Python toolkit for Nuclear Engineering}
\newacronym{PyRK}{PyRK}{Python for Reactor Kinetics}
\newacronym{pygen}{\texttt{PyGenesys}}{Python for Generating Energy Systems}
\newacronym{QA}{QA}{quality assurance}
\newacronym{RDD}{RD\&D}{Research Development and Demonstration}
\newacronym{RD}{R\&D}{Research and Development}
\newacronym{RELAP}{RELAP}{Reactor Excursion and Leak Analysis Program}
\newacronym{raven}{\texttt{RAVEN}}{Risk Analysis and Virtual Environment}
...
\newacronym{XAN}{XAN}{Expensive Advanced Nuclear}
\newacronym{YMR}{YMR}{Yucca Mountain Repository Site}
\newacronym{ZN}{ZN}{Nuclear Phaseout}
\newacronym{ZAN}{ZAN}{Zero Advanced Nuclear}
